...
1. Attend the Developer Relations Welcome Webinar
   * When: DAY \(DATE\) @ TIME 
   * Zoom Link: LINK
     * Please do complete the rest of your tasks. You do not have to attend this first before completing the rest of the tasks. 
...
7. Attend the General Welcome Webinar 
   * 11 AM on MONDAYS
